...
<s:form action="distributionbysicko" method="post" theme="simple">选择地区：<s:select
...
<script type="text/javascript">
	...
	function createChart1() {
		...
		document.getElementById("img001").src = 'distributionbysickochart.action?xml='
				+ xml + '&title=' + title;
	}
</script>
</html>