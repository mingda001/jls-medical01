...
<s:form action="distributionbyhospital" method="post" theme="simple">选择地区：<s:select
...
<script type="text/javascript">
	...
	function createChart1() {
		...
		document.getElementById("img001").src = 'distributionbyhospitalchart.action?xml='
				+ xml + '&title=' + title;
	}
	function createChart2() {
		...
		document.getElementById("img002").src = 'distributionbyhospitalchart.action?xml='
				+ xml + '&title=' + title;
	}
	function createChart3() {
		...
		document.getElementById("img003").src = 'distributionbyhospitalchart.action?xml='
				+ xml + '&title=' + title;
	}
	function createChart4() {
		...
		document.getElementById("img004").src = 'distributionbyhospitalchart.action?xml='
				+ xml + '&title=' + title;
	}
</script>
</html>