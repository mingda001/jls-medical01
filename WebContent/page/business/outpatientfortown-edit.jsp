...
<body>
<s:form action="saveOutpatientfortown" method="post" theme="simple">
	...
	<table align="center" width="90%" class="t1" border="0" cellpadding="0"
		...
		<tr>
			...
			<td><s:url id="dataUrl" value="querySickname.action" /><sx:autocompleter
				...
				href="querySickname.action?type=11" loadMinimumCount="1"
	...
	<table align="center" width="90%" class="t1" border="0" cellpadding="0"
		...
		<tr>
			<td>住院天数</td>
			<td><s:textfield name="businessDTO.days" cssStyle="width:80"
				value="0" onblur="countdays()" onfocus="countdays()" />天</td>
			<td width="90">&nbsp;</td>
			<td>&nbsp;</td>
...
<script type="text/javascript">
	function countdays() {
		...
		document.getElementById('saveOutpatientfortown_businessDTO_days').value = DateDiff(
				end1, begin1);
	}
	//计算天数差的函数，通用
