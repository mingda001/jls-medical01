...
<table align="center" width="90%" class="t1" border="0" cellpadding="0"
	...
	<tr>
		<td width="90">就诊医院</td>
		<td><s:property value="businessDTO.hospital"/></td>
		<td width="90">就医时间</td>
...
<table align="center" width="90%" class="t1" border="0" cellpadding="0"
	...
	<tr>
		<td width="90">入院时间</td>
		<td><s:date name="businessDTO.begintime"
			format="yyyy-MM-dd" /></td>
		<td width="90">出院时间</td>
		<td><s:date name="businessDTO.endtime"
			format="yyyy-MM-dd" /></td>
	...
	<tr>
		<td>自理费用</td>
		<td><s:property value="businessDTO.selfmoney" value="0" />元</td>
		<td width="90">自费合计</td>
