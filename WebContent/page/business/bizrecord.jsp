...
<table align="center" width="99%" class="t1" border="0" cellpadding="0"
	...
	<tr>
		<td colspan="10">
		<button class="btn"
			onclick="window.open('saveBizrecordinit.action?memberId=<s:property value="personDTO.memberId"/>&assistype=<s:property value="personDTO.assisTypeId" />&familyno=<s:property value="personDTO.familyno" />&ssn=<s:property value="personDTO.ssn" />','','height=500, width=700, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no')">新建业务</button>
