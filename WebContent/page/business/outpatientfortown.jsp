...
<table align="center" width="99%" class="t1" border="0" cellpadding="0"
	...
	<s:iterator value="bizs">
		<tr>
			...
			<s:url id="view" action="viewOutpatientfortown">
				<s:param name="bizId">
					<s:property value="bizId" />
				</s:param>
			</s:url>
			...
			onclick="window.open('countBiz.action?assistype=11-10&bizId=<s:property value="bizId" />&type=outpatientfortown&counttype=1&ssn=<s:property value="ssn" />','','height=500, width=700, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no')" title="计算保障金并保存">计算</button></s:if></td>
		</tr>
	</s:iterator>
	<tr>
		<td colspan="10">
		<button class="btn"
			onclick="window.open('saveOutpatientfortowninit.action?assistype=<s:property value="personDTO.assisTypeId" />&familyno=<s:property value="personDTO.familyno" />&ssn=<s:property value="personDTO.ssn" />','','height=500, width=700, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no')">新建业务</button>
