...
public class FileHandle {
	...
	private static String filepath = "com/medical/common/file-cfg.xml";
	...
	public static void main(String args[]) throws Exception {
		...
		String token = "220221196506264718";
		BASE64Decoder decoder = new BASE64Decoder();
		BASE64Encoder encoder = new BASE64Encoder();
		token =encoder.encode(token.getBytes()).toString();
		System.out.println(token);
		System.out.println("º”√‹:"+token);
		token = new String(decoder.decodeBuffer(token));
		System.out.println("Ω‚√‹:"+token);
	}
}
