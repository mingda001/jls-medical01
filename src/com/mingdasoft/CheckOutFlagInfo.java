 ...
 */
            ...
            /**
            *  CheckOutFlagInfo bean class
            */
        
        public  class CheckOutFlagInfo
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.lang.String localIllType ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localIllTypeTracker = false ;
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getIllType(){
                               return localIllType;
                           }
                            ...
                            /**
                               ...
                               * @param param IllType
                               */
                               public void setIllType(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localIllTypeTracker = true;
                                       } else {
                                          localIllTypeTracker = false;
                                              
                                       }
                                   
                                            this.localIllType=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       CheckOutFlagInfo.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CheckOutFlagInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CheckOutFlagInfo",
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"IllType", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"IllType");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("IllType");
                                    }
                                

                                          if (localIllType==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("IllType cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localIllType);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localHospitalIDTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://MingdaSoft.com/",
                                        ...
                                        if (localIllType != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIllType));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("IllType cannot be null!!");
                                        }
                                    }
    ...
    public static class Factory{
        ...
        */
        public static CheckOutFlagInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CheckOutFlagInfo object =
                new CheckOutFlagInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CheckOutFlagInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CheckOutFlagInfo)com.mingdasoft.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://MingdaSoft.com/","IllType").equals(reader.getName())){
