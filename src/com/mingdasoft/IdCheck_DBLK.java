 ...
 */
            ...
            /**
            *  IdCheck_DBLK bean class
            */
        
        public  class IdCheck_DBLK
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.lang.String localFamily_No ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localFamily_NoTracker = false ;
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getFamily_No(){
                               return localFamily_No;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param Family_No
                               */
                               public void setFamily_No(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localFamily_NoTracker = true;
                                       } else {
                                          localFamily_NoTracker = false;
                                              
                                       }
                                   
                                            this.localFamily_No=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       IdCheck_DBLK.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"Family_No", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"Family_No");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("Family_No");
                                    }
                                

                                          if (localFamily_No==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("Family_No cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localFamily_No);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localHospital_IDTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://MingdaSoft.com/",
                                        ...
                                        if (localFamily_No != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFamily_No));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("Family_No cannot be null!!");
                                        }
                                    } if (localNameTracker){
    ...
    public static class Factory{
        ...
        */
        public static IdCheck_DBLK parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IdCheck_DBLK object =
                new IdCheck_DBLK();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"IdCheck_DBLK".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (IdCheck_DBLK)com.mingdasoft.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://MingdaSoft.com/","Family_No").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://MingdaSoft.com/","Name").equals(reader.getName())){
